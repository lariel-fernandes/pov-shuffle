...
params = TimePerDeckSizeParams(
    ...
    povs_options_per_deck_size={
        256: POVSOptions(physical_block_size=16, virtual_block_size=3, offset_step_size=4, max_offset_steps=8),
        512: POVSOptions(physical_block_size=32, virtual_block_size=3, offset_step_size=4, max_offset_steps=8),
        1024: POVSOptions(physical_block_size=32, virtual_block_size=3, offset_step_size=4, max_offset_steps=16),
        2048: POVSOptions(physical_block_size=32, virtual_block_size=4, offset_step_size=4, max_offset_steps=16),
        4096: POVSOptions(physical_block_size=64, virtual_block_size=4, offset_step_size=8, max_offset_steps=16),
        8192: POVSOptions(physical_block_size=64, virtual_block_size=4, offset_step_size=8, max_offset_steps=16),
        16384: POVSOptions(physical_block_size=128, virtual_block_size=4, offset_step_size=16, max_offset_steps=16),
    },
)
